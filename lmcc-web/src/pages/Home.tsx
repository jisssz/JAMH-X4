...
export const Home: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-100 via-slate-50 to-white flex flex-col justify-between">
      ...
      {/* Main Hero Container */}
      <main className="max-w-lg w-full mx-auto px-4 py-6 sm:py-8 flex-1 flex flex-col justify-center">
        {/* Hero Section with Ripple Distortion Background */}
        <section className="relative overflow-hidden rounded-3xl bg-slate-950 text-white p-6 sm:p-7 shadow-2xl border border-slate-800/80 mb-6">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            {/* Title & Introduction */}
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-500/20 border border-emerald-500/40 text-emerald-300 text-xs font-semibold mb-3 backdrop-blur-sm">
            ...
            <p className="mt-2.5 text-xs sm:text-sm text-slate-300 leading-relaxed max-w-md mx-auto">
            ...
            <button
              ...
              className="mt-6 w-full bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700 hover:from-emerald-500 hover:to-teal-500 text-white p-4 sm:p-5 rounded-2xl shadow-xl shadow-emerald-950/50 flex items-center justify-between group transition-all duration-200 active:scale-[0.98] border border-emerald-400/30"
            >
              <div className="flex items-center gap-3.5 sm:gap-4">
                <div className="w-12 h-12 rounded-xl bg-white/20 backdrop-blur-md flex items-center justify-center p-2.5 text-amber-300">
                ...
                <div className="text-left">
                  ...
                  <span className="text-base sm:text-lg font-bold block">Scan Product Label</span>
                  <span className="text-[11px] sm:text-xs text-white/80">Use phone camera with live targeting</span>
                </div>
              </div>
              <ChevronRight className="w-5 h-5 sm:w-6 sm:h-6 text-white/80 group-hover:translate-x-1 transition" />
            </button>
          </div>
        </section>
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full bg-white hover:bg-slate-50 border-2 border-slate-200 hover:border-gov-500 text-slate-800 p-4 sm:p-5 rounded-2xl shadow-sm flex items-center justify-between group transition-all duration-200 active:scale-[0.98]"
          >
            <div className="flex items-center gap-3.5 sm:gap-4">
              <div className="w-12 h-12 rounded-xl bg-slate-100 flex items-center justify-center p-2.5 text-gov-600">
                <UploadCloud className="w-6 h-6" />
              </div>
              <div className="text-left">
                <span className="text-base sm:text-lg font-bold block text-slate-900">Upload Label Image</span>
                <span className="text-xs text-slate-500">Select photo from your device or gallery</span>
              </div>
            </div>
            <ChevronRight className="w-5 h-5 sm:w-6 sm:h-6 text-slate-400 group-hover:translate-x-1 transition" />
          </button>
          ...
          <button
            type="button"
            onClick={() => navigate('/history')}
            className="w-full bg-slate-50 hover:bg-slate-100 border border-slate-200/80 text-slate-700 p-3.5 sm:p-4 rounded-2xl shadow-xs flex items-center justify-between group transition-all duration-150 active:scale-[0.99]"
          >
            <div className="flex items-center gap-3">
